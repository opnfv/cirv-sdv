...
CWD = os.getcwd()
GSW_PATH = 'path/to/gsw'


class Validate():
    """ Validation class """

    def __init__(self, yaml_dir, mapping_file_type, json_fn, type_sw_dir):
...
if __name__ == "__main__":
    ...
    print(Validate(os.path.join(ARGS.inst_dir, 'sites', ARGS.sitename), ARGS.inst_type, ARGS.pdf, \
        os.path.join(ARGS.inst_dir, 'type')).validate())
